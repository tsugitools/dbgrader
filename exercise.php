...
function dbgrader_resolve_exercise_key() {
    ...
    if ($LINK) {
        ...
        // "Please select", empty, or a key not in this tool's catalog — treat
        // as unset so ?exercise= can still configure the placement.
 ...
 * keys are handled earlier by dbgrader_resolve_exercise_key().
 */
